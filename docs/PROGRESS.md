...
- Backend/data final gates: Composer validation/audit, targeted P0 suites, Larastan, Pint, fresh isolated migration and repeated demo seed pass. The first sequential full run correctly exposed a cross-process collision with a concurrently running coverage process: backup/restore tests used fixed SQLite sandbox paths. After adding PID/random path isolation, the focused restore suite passed 4 tests/24 assertions, sequential Pest passed 878 total/869 passed/9 skipped/23,166 assertions, parallel Pest passed 949 total/940 passed/9 skipped/23,378 assertions, and canonical coverage passed 945 total/936 passed/9 skipped/23,265 assertions at 91.9%.
