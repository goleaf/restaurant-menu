...
- Public, waiter, service-point and menu mobile Lighthouse accessibility scored 100; the final checked pages had no console errors/issues or horizontal overflow, and critical operational actions use practical touch-target sizing at the 390 px touch viewport.
