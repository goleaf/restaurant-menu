function registerWorkspaceNavigation() {
...
if (window.Alpine) registerWorkspaceNavigation();
else document.addEventListener('alpine:init', registerWorkspaceNavigation, { once: true });
