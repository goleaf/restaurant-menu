...
- **Correctness:** PHP 8.5 syntax, configured Larastan with 0 errors, 854 Pest tests with 845 passing and 9 feature-gated skips, 73 fresh migrations, complete repeated demo seeding and EN/LT/RU parity pass on the final tree.
