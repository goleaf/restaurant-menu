...
test('livewire security boundary properties are locked', function (string $component, string $property): void {
    ...
    'guest menu item add attempt id' => [GuestMenu::class, 'itemAddAttemptId'],
    ...
    'guest table guests public token' => [TableGuests::class, 'publicToken'],
    'guest order statuses table session id' => [OrderStatuses::class, 'tableSessionId'],
    'guest order statuses current guest id' => [OrderStatuses::class, 'currentGuestId'],
    'guest order statuses public token' => [OrderStatuses::class, 'publicToken'],
