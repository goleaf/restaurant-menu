...
final class OrganizationCrudMatrix
{
    ...
    {
        return [
            'organization' => self::resource('Organization', '/organizations', 'Create organization', 'Paginate accessible organizations', 'Update identity and logo', 'Soft delete after confirmation', 'Canonical demo organization with logo', 'tests/Feature/OrganizationManagementTest.php', ['app/Livewire/Restaurants/Index.php', 'app/Livewire/Restaurants/IdentityEditor.php', 'app/Livewire/Restaurants/StructureCreate.php', 'app/Actions/Organizations/CreateStructureIdentityAction.php', 'app/Actions/Organizations/CreateOrganizationAction.php', 'app/Actions/Organizations/UpdateOrganizationAction.php', 'app/Actions/Organizations/ChangeStructureLifecycleAction.php']),
            'brand' => self::resource('Brand', 'Organization brands', 'Create brand', 'Paginate tenant brands', 'Update identity and logo', 'Soft delete after confirmation', 'Three demo brands with media coverage', 'tests/Feature/BrandManagementTest.php', ['app/Livewire/Restaurants/Index.php', 'app/Livewire/Restaurants/IdentityEditor.php', 'app/Livewire/Restaurants/StructureCreate.php', 'app/Actions/Organizations/CreateStructureIdentityAction.php', 'app/Actions/Brands/CreateBrandAction.php', 'app/Actions/Brands/UpdateBrandAction.php', 'app/Actions/Organizations/ChangeStructureLifecycleAction.php']),
            'branch' => self::resource('Branch', 'Brand branches', 'Create branch', 'Paginate authorized branches', 'Update identity, locale, currency and state', 'Soft delete after confirmation', 'Active and inactive demo branches', 'tests/Feature/BranchManagementTest.php', ['app/Livewire/Restaurants/Index.php', 'app/Livewire/Restaurants/IdentityEditor.php', 'app/Livewire/Onboarding/RestaurantSetup.php', 'app/Actions/Onboarding/CreateRestaurantSetupAction.php', 'app/Actions/Branches/CreateBranchAction.php', 'app/Actions/Branches/UpdateBranchAction.php', 'app/Actions/Organizations/ChangeStructureLifecycleAction.php']),
            ...
            'branch_settings' => self::resource('Branch settings', 'Branch settings', 'Initialize on creation or explicit save', 'Read effective settings without writes', 'Save independently versioned groups', 'Cancel only unsaved group edits', 'Complete settings for every demo branch', 'tests/Feature/BranchSettingsTest.php', ['app/Livewire/Organizations/Brands/Branches/Settings.php', 'app/Actions/Branches/SaveBranchSettingsGroupAction.php']),
            'opening_hours' => self::resource('Opening hours', 'Branch availability workspace', 'Add opening intervals', 'Read weekly schedule', 'Replace opening intervals', 'Remove intervals or close day', 'Regular, split and closed demo days', 'tests/Feature/BranchOpeningHoursTest.php', ['app/Livewire/Organizations/Brands/Branches/Availability/Index.php', 'app/Actions/Branches/UpdateBranchOpeningHoursAction.php']),
            'temporary_closure' => self::resource('Temporary closure', 'Branch availability workspace', 'Set temporary closure', 'Read closure state', 'Update reason and end time', 'Clear closure', 'One bounded demo closure', 'tests/Feature/BranchTemporaryClosedModeTest.php', ['app/Livewire/Organizations/Brands/Branches/Availability/Index.php', 'app/Actions/Branches/UpdateBranchTemporaryClosureAction.php']),
            ...
            'menu_schedule' => self::resource('Menu availability schedule', 'Branch availability workspace', 'Create interval', 'Read ordered intervals', 'Update day and time range', 'Delete interval', 'Weekday and weekend intervals', 'tests/Feature/MenuScheduleTest.php', ['app/Livewire/Organizations/Brands/Branches/Availability/Index.php', 'app/Actions/Menus/SaveMenuAvailabilityScheduleAction.php']),
