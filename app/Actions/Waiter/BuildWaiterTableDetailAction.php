...
class BuildWaiterTableDetailAction
{
    ...
    private function paymentPayload(
        ...
        return [
            ...
            'service_charge_enabled' => (bool) ($summary['service_charge_enabled'] ?? false),
            'service_charge_percent' => $summary['service_charge_percent'] ?? '0.00',
            'service_charge_total_cents' => (int) ($summary['service_charge_total_cents'] ?? 0),
            'service_charge_paid_cents' => (int) ($summary['service_charge_paid_cents'] ?? 0),
            'remaining_service_charge_cents' => (int) ($summary['remaining_service_charge_cents'] ?? 0),
            'service_charge_total' => $summary['service_charge_total'] ?? '0.00 EUR',
            'service_charge_paid' => $summary['service_charge_paid'] ?? '0.00 EUR',
            'remaining_service_charge' => $summary['remaining_service_charge'] ?? '0.00 EUR',
            'tips_enabled' => (bool) ($summary['tips_enabled'] ?? false),
            'tips_paid_total_cents' => (int) ($summary['tips_paid_total_cents'] ?? 0),
            'tips_paid_total' => $summary['tips_paid_total'] ?? '0.00 EUR',
            'confirmed_total_cents' => (int) ($summary['confirmed_total_cents'] ?? 0),
            'covered_subtotal_cents' => (int) ($summary['covered_subtotal_cents'] ?? 0),
            'remaining_subtotal_cents' => (int) ($summary['remaining_subtotal_cents'] ?? 0),
            ...
            'covered_subtotal' => $summary['covered_subtotal'] ?? '0.00 EUR',
            'remaining_subtotal' => $summary['remaining_subtotal'] ?? '0.00 EUR',
