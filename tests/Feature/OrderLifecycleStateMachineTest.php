...
test('order and department item states expose one centralized transition contract', function (): void {
    expect(TableSessionStatus::Closed->isTerminal())->toBeTrue()
        ...
        ->and(KitchenTicketItemStatus::New->canTransitionTo(KitchenTicketItemStatus::Accepted))->toBeTrue()
        ->and(KitchenTicketItemStatus::Accepted->canTransitionTo(KitchenTicketItemStatus::InProgress))->toBeTrue()
        ->and(KitchenTicketItemStatus::Accepted->canTransitionTo(KitchenTicketItemStatus::New))->toBeFalse()
