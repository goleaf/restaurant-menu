...
- **Correctness:** PHP 8.5 syntax, configured Larastan level 5 across 502 files, 757 passing Pest tests, 70 fresh migrations, complete repeated demo seeding and EN/LT/RU parity pass on the final tree.
