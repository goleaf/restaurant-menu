...
test('dashboard entry views keep visible chrome translatable', function () {
    $dashboardSources = [
        resource_path('views/livewire/workspace/entry.blade.php'),
...
test('staff and permission ui uses semantic json translation keys in every locale', function () {
    $staffKeys = [
        'staff.list',
        'staff.workspace.employees',
        'staff.workspace.assignments',
        'staff.workspace.preview',
        'staff.link.label',
        'staff.link.fallback',
        'staff.statuses.suspended',
        'staff.invite',
        'team.card.change_status',
        'team.card.status_help',
        'staff.role',
        'staff.branch_access',
        'staff.organization_access',
        'team.card.apply_permissions',
...
test('reports ui uses semantic json translation keys in every locale', function () {
    $reportKeys = [
        'reports.title',
        'dashboard.control.report.today',
        'dashboard.control.report.custom',
        'dashboard.control.choose_branch',
        'reports.filters.status',
        'reports.revenue.total_paid',
        'reports.revenue.net_total',
        'reports.orders.title',
        'dashboard.control.report.popular_items',
        'dashboard.control.report.quantity',
    ...
    $reportSupportKeys = [
        ...
        'dashboard.control.report.no_access',
        'dashboard.control.report.no_access_description',
        'dashboard.control.report.updated_at',
        'dashboard.control.operation_all',
        'dashboard.control.operation_pending',
        'dashboard.control.now.title',
        'dashboard.control.operation_ready',
        'dashboard.control.main_links',
