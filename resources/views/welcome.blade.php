<x-layouts::guest :title="__('Restaurant Menu SaaS')">
        ...
        <section class="mx-auto flex min-h-svh w-full max-w-5xl flex-col justify-between gap-8 px-4 py-6 sm:px-6 lg:px-8">
            ...
            <div class="grid gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
                <div class="flex flex-col gap-5">
                    <p class="text-sm font-medium text-emerald-700 dark:text-emerald-300">{{ __('Shared-hosting restaurant platform') }}</p>
                    <h1 class="max-w-2xl text-3xl font-semibold leading-tight sm:text-4xl">
                        {{ __('QR ordering, waiter flow, kitchen screens, and restaurant dashboards in one local-first SaaS.') }}
                    </h1>
                    <p class="max-w-xl text-base leading-7 text-zinc-600 dark:text-zinc-300">
                        {{ __('Guests normally start from a permanent QR link. Staff can manage restaurants, tables, menus, orders, payments, reports, and platform access after signing in.') }}
                    </p>
                </div>
                ...
                <div class="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                    <div class="flex flex-col gap-3">
                        ...
                        <a
                            ...
                            wire:navigate
                        >
                            <span>{{ __('Restaurant dashboard') }}</span>
                            <span aria-hidden="true">-></span>
                        </a>
                        <a
                            ...
                            wire:navigate
                        >
                            <span>{{ __('Platform dashboard') }}</span>
                            <span aria-hidden="true">-></span>
                        </a>
                    </div>
                </div>
