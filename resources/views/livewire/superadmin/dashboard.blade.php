<section data-layout="platform-dashboard" class="flex h-full w-full flex-1 flex-col gap-6">
    <x-ui.page-header
        title="ui.superadmin.dashboard.platform_dashboard"
        description="ui.superadmin.dashboard.saas_level_overview_for_organizations_brands_branch"
        context="ui.superadmin.dashboard.platform_workspace"
    />
    ...
    <section class="grid gap-4 md:grid-cols-3 xl:grid-cols-6">
        @foreach ($statRows as $stat)
            <div wire:key="platform-stat-{{ $stat['key'] }}" class="rounded-card border border-border-subtle bg-surface p-4">
        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div class="flex flex-col gap-2 sm:flex-row">
                <x-dangerous-action-confirmation
                    ...
                    reason-model="sqliteBackup.reason"
                    reason-required
                    confirmation-model="sqliteBackup.confirmation"
                ...
                <x-dangerous-action-confirmation
                    ...
                    reason-model="restoreBackup.reason"
                    reason-required
                    confirmation-model="restoreBackup.confirmation"
                ...
                <x-dangerous-action-confirmation
                    ...
                    confirm-label="ui.actions.i_understand"
                    reason-model="mediaBackup.reason"
                    reason-required
                    confirmation-model="mediaBackup.confirmation"
