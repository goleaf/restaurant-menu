...
final class OrganizationCrudMatrix
{
    ...
    public static function resources(): array
    {
        return [
            ...
            'menu_item_images' => self::resource('Menu item images', 'Dish edit form', 'Upload up to eight images', 'Read primary and ordered gallery', 'Promote gallery image to primary', 'Remove image and clean parent media', 'Primary and secondary representative images', 'tests/Feature/MenuCrudTest.php', ['app/Livewire/Organizations/Brands/Branches/Menu/Catalog.php', 'app/Actions/Menus/ReplaceMenuItemImageAction.php']),
