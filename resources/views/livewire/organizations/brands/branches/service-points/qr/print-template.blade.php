<main data-page="qr-print-template" class="qr-print-page flex min-h-svh flex-col items-center gap-4 px-4 py-6 qr-print-page-single">
    <div class="qr-print-toolbar rm-print-toolbar">
        ...
        <div class="flex flex-wrap items-center gap-2">
            ...
            <flux:button icon="arrow-down-tray" type="button" wire:click="downloadPdf" wire:loading.attr="disabled" wire:target="downloadPdf">
