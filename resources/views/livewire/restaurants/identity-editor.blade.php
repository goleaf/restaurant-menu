    ...
    @if ($canEdit)
        <form novalidate wire:submit="save" class="rm-restaurant-center__form">
            ...
            @if ($isRestaurant)
                ...
                <flux:select wire:model="form.timezone" variant="listbox" searchable :label="__('center.timezone')" :description="__('settings.timezone_help')" error:id="center-identity-form-timezone-error" error:class="text-danger!" aria-describedby="center-identity-form-timezone-error">
