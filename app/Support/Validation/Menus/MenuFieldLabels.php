...
final class MenuFieldLabels
{
    ...
    public static function forEditor(string $editor): array
    {
        ...
        $attributes = array_map(static fn (string $key): string => __($key), $fields);
