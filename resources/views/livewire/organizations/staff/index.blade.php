<section data-page="organization-staff" class="flex h-full w-full flex-1 flex-col gap-6">
    <header class="flex flex-col gap-3">
        ...
        <div class="flex flex-col gap-1">
            ...
            <h1 class="text-2xl font-semibold text-zinc-950 dark:text-white">{{ __('Organization staff') }}</h1>
        </div>
    </header>
    ...
    <div class="grid gap-4 xl:grid-cols-2">
        <form wire:submit="addManualStaffMember" class="rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
            <div class="flex flex-col gap-4">
                <flux:heading size="lg">{{ __('Add staff member manually') }}</flux:heading>
        ...
        <form wire:submit="createInviteLink" class="rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
            <div class="flex flex-col gap-4">
                <flux:heading size="lg">{{ __('Create invitation') }}</flux:heading>
    ...
    <div class="overflow-hidden rounded-lg border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
        <div class="border-b border-zinc-200 px-4 py-3 dark:border-zinc-800">
            <flux:heading size="lg">{{ __('Staff members') }}</flux:heading>
        </div>
