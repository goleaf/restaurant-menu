...
7. Run `composer translations:audit` and the locale-focused Pest tests.
...
`docs/TRANSLATION_KEY_MAP.md` remains a namespace reference; this file is the canonical policy.
