...
use App\Observers\BranchScheduleExceptionObserver;
...
use App\Observers\MenuItemImageObserver;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    protected function registerModelObservers(): void
    {
        ...
        BranchScheduleException::observe(BranchScheduleExceptionObserver::class);
        ...
        MenuItemImage::observe(MenuItemImageObserver::class);
