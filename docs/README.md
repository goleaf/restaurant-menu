...
| [DEMO_LOGIN.md](DEMO_LOGIN.md) | Current | Local-only demo login list for seeded `@demo.test` accounts and the safe demo password convention. | When demo user emails, roles, password convention, or seeded demo access changes. | Developers and QA using local/demo data. |
