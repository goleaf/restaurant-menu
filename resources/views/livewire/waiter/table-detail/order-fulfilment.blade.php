        ...
        <div class="mt-4 text-sm">
            ...
            @if (data_get($orderFulfilment, 'draft.can_cancel'))
                <div class="mt-4 space-y-3 border-t border-border-subtle pt-4">
                    ...
                    >
                        <x-slot:trigger>
                            <flux:button icon="x-mark" variant="primary" color="red" type="button" class="rm-action-danger w-full">{{ __('orders.actions.cancel') }}</flux:button>
                        </x-slot:trigger>
                    </x-dangerous-action-confirmation>
                </div>
            @endif
                        ...
                        @foreach ($order['items'] as $orderItem)
                            ...
                            >
                                ...
                                @if ($orderItem['can_cancel'])
                                    ...
                                    >
                                        <x-slot:trigger>
                                            <flux:button icon="x-mark" variant="primary" color="red" size="sm" type="button" class="rm-action-danger mt-3 w-full">{{ __('orders.items.actions.cancel') }}</flux:button>
                                        </x-slot:trigger>
                                    </x-dangerous-action-confirmation>
                                @endif
                            </section>
